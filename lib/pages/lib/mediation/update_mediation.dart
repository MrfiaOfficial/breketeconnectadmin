...
class UpdateMediation extends StatefulWidget {
  final String mediationUid;
  ...
  @override
  _UpdateMediationState createState() => _UpdateMediationState();
}

class _UpdateMediationState extends State<UpdateMediation> {
  List<String> _case = [
    'Family',
    'Government',
    'Corporate',
  ...
  Future<bool> _updateMediation(String mediationUid) async {
    try {
      Map<String, dynamic> mediationDataMap = {
      ...
      await FirebaseFirestore.instance
          ...
          .doc(widget.mediationUid)
          .update(mediationDataMap);
      ...
      Fluttertoast.showToast(
          msg: 'Mediation Successfully Updated!',
                          ...
                          child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if (fKey.currentState.validate()) {
                                  ...
                                  await _updateMediation(widget.mediationUid);
                                  setState(() {
                                    isLoading = false;
                                  });
                                }
